...
(gtk_accel_path "<Actions>/ThunarActions/uca-action-1609072041874463-1" "<Primary>y")
; (gtk_accel_path "<Actions>/ThunarWindow/sendto-menu" "")
; (gtk_accel_path "<Actions>/ThunarBookmarks/991c198183214c0c90ac0cfcefba7804" "")
...
(gtk_accel_path "<Actions>/ThunarActions/uca-action-1581682641375192-1" "<Primary>g")
(gtk_accel_path "<Actions>/ThunarStandardView/create-document" "<Primary>e")
; (gtk_accel_path "<Actions>/ThunarShortcutsPane/sendto-shortcuts" "")
; (gtk_accel_path "<Actions>/ThunarWindow/close-tab" "<Primary>w")
(gtk_accel_path "<Actions>/ThunarWindow/view-side-pane-tree" "<Primary>k")
; (gtk_accel_path "<Actions>/ThunarLauncher/execute" "")
; (gtk_accel_path "<Actions>/ThunarWindow/toggle-side-pane" "F9")
; (gtk_accel_path "<Actions>/ThunarWindow/open-home" "<Alt>Home")
(gtk_accel_path "<Actions>/ThunarStandardView/rename" "<Primary>z")
; (gtk_accel_path "<Actions>/ThunarWindow/open-templates" "")
; (gtk_accel_path "<Actions>/ThunarWindow/open-location-alt" "<Alt>d")
(gtk_accel_path "<Actions>/ThunarWindow/close-window" "<Primary><Shift>n")
